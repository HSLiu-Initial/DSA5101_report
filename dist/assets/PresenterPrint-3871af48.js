import{d as m,u as d,a as _,c as u,b as p,r as h,o as a,e as n,f as t,t as s,g as l,F as f,h as g,n as v,i as x,j as y,k as b,l as B,m as N,_ as k}from"./index-769cec46.js";import{N as D}from"./NoteDisplay-4879202c.js";const P={class:"m-4"},S={class:"mb-10"},w={class:"text-4xl font-bold mt-2"},F={class:"opacity-50"},L={class:"text-lg"},V={class:"font-bold flex gap-2"},C={class:"opacity-50"},E=t("div",{class:"flex-auto"},null,-1),T={key:0,class:"border-gray-400/50 mb-8"},j=m({__name:"PresenterPrint",setup(A){d(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
